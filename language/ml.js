...
exports.limit = (prefix) =>{
	return` ⚠️ നിങ്ങളുടെ പരിധി കഴിഞ്ഞു, പരിധി പരിശോധിക്കാൻ ${prefix}limit അയയ്ക്കുക`
}
exports.limitg= (prefix) =>{
	return` ⚠️ നിങ്ങളുടെ ഗെയിം പരിധി കഴിഞ്ഞു, പരിധി പരിശോധിക്കാൻ ${prefix}limit അയയ്ക്കുക`
}
exports.event = (prefix) =>{
	return` ⚠️ ഗ്രൂപ്പ് ഇവന്റ് സജീവമാക്കിയിട്ടില്ല, സജീവമാക്കുന്നതിന് ${prefix}event on എന്ന കമാൻഡ് അയയ്ക്കുക`
}
exports.wait = () => {
