...
module.exports = {
   ...
   * @param {String} server (avaiable: `id4`, `en60`, `en61`, `en68`)
   */
  ytv2(url, server = 'en68') { return yt(url, '480p', 'mp4', '480', server) },
  ytv3(url, server = 'en68') { return yt(url, '720p', 'mp4', '720', server) },
  ytv4(url, server = 'en68') { return yt(url, '1080p', 'mp4', '1080', server) },
